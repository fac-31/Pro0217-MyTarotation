...
export const getNewFortunePage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        <div class="flex items-center justify-center w-full">
            <form 
                ...
                class="bg-gradient-to-tr from-purple-900 via-indigo-800 to-purple-700 
                      ...
                      rounded-xl shadow-xl p-6 w-11/12 max-w-2xl grow"
            >
                <h2 class="text-2xl font-bold mb-4 text-center">
                  Reveal Your Fortune
                </h2>
    
                <div id="form-section-1" class="content">
                    <div class="grid grid-cols-3 gap-6">
                        <div class="flex flex-col">
                            <label for="name" class="font-semibold text-yellow-200">
                              Name
                            </label>
                            <input 
                              id="name" 
                        ...
                        <div class="flex flex-col">
                            <div id="starsign-dropdown" class="hidden">
                                <label for="starsign" class="font-semibold text-yellow-500">
                                  Starsign
                                </label>
                                <select
                                  id="starsign"
                            ...
                            <div id="dob-date" class="block">
                                <label for="dob" class="font-semibold text-yellow-200">
                                    Date of Birth
                                </label>
                                <input 
                                    id="dob" 
                        ...
                        <div class="flex flex-col">
                            <label for="mood" class="font-semibold text-yellow-200">
                                Current Mood
                            </label>
                            <input 
                                id="mood" 
...
export const postNewFortune = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        ...
        const recommendations = yield handleRecommendations(req, { age, mood, interests });
        ...
        yield saveFortune(newFortune);
        yield saveMoods(recommendations.mood);
        if (!recommendations) {
            return res.renderWithLayout(`<p class="text-red-500">Error fetching recommendations.</p>`, { title: "Error" });
        }
        if (!((_a = recommendations.books) === null || _a === void 0 ? void 0 : _a.length) && !((_b = recommendations.movies) === null || _b === void 0 ? void 0 : _b.length)) {
            return res.renderWithLayout(`<p class="text-red-500">No recommendations found.</p>`, { title: "Recommendations" });
        }
        res.renderWithLayout(yield generateCardLayout(recommendations, _id), { title: "Your Fortune", nav: true, fortuneTellerImg: 'success' });
    }
    catch (error) {
...
export const getRandomFortune = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let fortune = yield getRandom();
        if (!fortune) {
        ...
        res.renderWithLayout(yield generateCardLayout(recommendations, _id), {
