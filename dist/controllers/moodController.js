...
export const getMoodPage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
export const getMoodFortune = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (req.query.mood) {
            const matchMoodAIresponse = yield matchMood(requestMsg);
            requestMsg = matchMoodAIresponse.closestMood;
            // console.log("Matched Mood:", requestMsg);
        }
        let fortune = yield getRandomMoodFortune(requestMsg);
        if (!fortune) {
